...
import com.sensetime.senseid.facepro.jniwrapper.library.DetectResults;
import com.sensetime.senseid.facepro.jniwrapper.library.FloatResult;
import com.sensetime.senseid.facepro.jniwrapper.library.HandleResult;
import com.sensetime.senseid.facepro.jniwrapper.library.SearchResult;
import com.sensetime.senseid.facepro.jniwrapper.library.StringResult;
...
public interface StSdk extends StdCallLibrary {

	StSdk INSTANCE = (StSdk) Native.loadLibrary("so//libstidfacepro_api",  //lib\\HCNetSDK
			StSdk.class);
	...
	public static final int ST_OK = 0;
	  ...
	  public FloatResult binocularlivenessDetect(Object paramObject, byte[] paramArrayOfByte1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte2, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, DetectResult paramDetectResult1, DetectResult paramDetectResult2);
	  
	  public  void destroyBinocularliveness(Object paramObject);
	  
	  public  HandleResult createBinocularliveness(String paramString);
	  
	  public  void destroyBinocularlivenessTracker(Object paramObject);
	  
	  public  void resetBinocularlivenessTracker(Object paramObject);
	  
	  public  BinocularResult binocularlivenessTrack(Object paramObject, byte[] paramArrayOfByte1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte2, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9);
	  
	  public  HandleResult createBinocularlivenessTracker(String paramString, int paramInt);
	  
	  public  FloatResult singlelivenessDetect(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, DetectResult paramDetectResult);
	  
	  public  void destroySingleliveness(Object paramObject);
	  
	  public  HandleResult createSingleliveness(String paramString, int paramInt);
	  
	  public  FloatResult livenessFrameSelectorDetector(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, double paramDouble, int paramInt5, DetectResult paramDetectResult);
	  
	  public  void destroyLivenessSelector(Object paramObject);
	  
	  public  HandleResult createLivenessSelector(String paramString);
	  
	  public  void resetLivenessSelector(Object paramObject);
	  
	  //public  FloatResult imageQualitySharpness(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, Rect paramRect);
	  
	  public  SearchResult verifySearchFaceFromList(Object paramObject, String[] paramArrayOfString, int paramInt1, String paramString, int paramInt2, int paramInt3);
	  
	  public  FloatResult verifyCompareFeature(Object paramObject, String paramString1, String paramString2);
	  
	  public  StringResult verifyGetFeature(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, DetectResult paramDetectResult);
	  
	  public  void verifyDestroyHandle(Object paramObject);
	  
	  public  HandleResult verifyDuplicateHandle(Object paramObject);
	  
	  public  HandleResult verifyCreateHandle(String paramString);
	  
	  public  int trackSetDetectFaceCntLimit(Object paramObject, int paramInt);
	  
	  public  void resetTracker(Object paramObject);
	  
	  public  DetectResults track(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
	  
	  public  void destroyTracker(Object paramObject);
	  
	  public  HandleResult createTracker(String paramString, int paramInt);
	  
	  public  DetectResults detect(Object paramObject, byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
	  
	  public  void destroyDetector(Object paramObject);
	  
	  public  int setThreshold(Object paramObject, float paramFloat);
	  
	  public  FloatResult getThreshold(Object paramObject);
	  
	  public  HandleResult createDetector(String paramString, int paramInt);
	  
	  public  int setLogType(int paramInt1, int paramInt2);
	  
	  public  int addLicense(String paramString);
	  
	  public  int activite(String paramString);
	  
	  public  StringResult getActivationCode(String paramString);
